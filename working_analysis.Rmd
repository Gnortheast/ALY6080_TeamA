...
## Random Sample - 25 People Frustrations


```{r, include = FALSE}
sample(people_frustrations, 25)
```
...
1394 Comments related to task/chores, too many to print below. 745 (53%) include complaints including the word "time". 
