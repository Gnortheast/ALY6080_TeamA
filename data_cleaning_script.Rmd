...
#The code below creates a subset of the data for those that did laundry 
and joins the demo data to the diary data based on the last demo entry. 

A csv is created for the customer view dashboard (Gabriella)
...
on demo1.respondent_id=ds.respondent_id
