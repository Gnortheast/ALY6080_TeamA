...
#Additional subsets for Tableau analysis
```{r}
#Subset for only yes laundry days 
diary_subset = diary[diary$Laundry_Event_Today. %in% c("Yes"),] #number of rows decreases from 93,705 to 45,043 that did laundry
```
...
write.csv(diary_subset, "diary_subset.csv", row.names=FALSE)
```
